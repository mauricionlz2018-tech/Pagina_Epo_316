  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white">Eventos Escolares</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1 text-sm md:text-base">Organiza y gestiona eventos institucionales</p>
        </div>
        <Button
          onClick={() => {
            setShowForm(true);
      ...
      <Dialog open={showForm} onOpenChange={setShowForm}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 mt-4">
            <div className="bg-orange-50 dark:bg-orange-900 border border-orange-100 dark:border-orange-800 p-4 rounded-lg">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-orange-400 focus:border-transparent bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                  />
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-orange-400 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
            >
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-slate-100 dark:bg-gray-700">
                  <tr>
                    <th className="px-4 py-3 text-left font-semibold text-gray-700 dark:text-gray-300">Nombre</th>
                    ...
                    <th className="px-4 py-3 text-left font-semibold text-gray-700 dark:text-gray-300">Lugar</th>
                ...
                <tbody>
                  {eventosFiltrados.map((evento) => (
                    <tr key={evento.id} className="border-t hover:bg-slate-50 dark:hover:bg-gray-700 transition">
                      <td className="px-4 py-3 font-medium text-gray-800 dark:text-white">{evento.nombre}</td>
                      <td className="px-4 py-3 text-gray-700 dark:text-gray-400">{evento.tipo_evento}</td>
                      <td className="px-4 py-3 text-sm text-gray-700 dark:text-gray-400">
                        {new Date(evento.fecha_evento).toLocaleDateString('es-MX')}
                      </td>
                      <td className="px-4 py-3 text-sm flex items-center gap-1 text-gray-700 dark:text-gray-400">
                        <MapPin size={14} className="text-gray-500" />
                        {evento.lugar || '-'}
                      </td>
                      <td className="px-4 py-3">
                        <span className={`px-2 py-1 rounded text-xs font-semibold ${
                          evento.estado === 'Realizado' ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900 dark:text-emerald-100' :
                          evento.estado === 'Programado' ? 'bg-sky-100 text-sky-700 dark:bg-sky-900 dark:text-sky-100' :
