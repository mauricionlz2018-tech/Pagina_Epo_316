...
export default function DocentePanel() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div className="bg-gradient-to-r from-emerald-700 to-emerald-900 text-white p-6 rounded-xl">
      ...
      {/* Teaching Actions */}
      <div>
        <h2 className="text-xl md:text-2xl font-bold mb-4 text-gray-900 dark:text-white">Acciones Docentes</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          <Card className="p-4 md:p-6 hover:shadow-lg transition cursor-pointer bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
            <div className="flex items-start gap-3 md:gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-bold text-base md:text-lg text-gray-900 dark:text-white">Planificación de Clases</h3>
          ...
          <Card className="p-4 md:p-6 hover:shadow-lg transition cursor-pointer bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
            <div className="flex items-start gap-3 md:gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-bold text-base md:text-lg text-gray-900 dark:text-white">Retroalimentación</h3>
          ...
          <Card className="p-4 md:p-6 hover:shadow-lg transition cursor-pointer bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
            <div className="flex items-start gap-3 md:gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="font-bold text-base md:text-lg text-gray-900 dark:text-white">Análisis de Rendimiento</h3>
      ...
      <Card className="p-6 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
        <h3 className="font-bold text-lg mb-3 text-gray-900 dark:text-white">Indicadores Académicos</h3>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div>
